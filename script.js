...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const themeToggle = document.getElementById('theme-toggle');
   ...
   langPT.addEventListener('click', () => {
        ...
        document.getElementById('advantage-5').textContent = 'Perfomance';
        ...
        document.getElementById('advantage-14').textContent = 'Perfomance';
        ...
        document.getElementById('service-2').textContent = 'Sites';
        document.getElementById('service-3').textContent = 'Lojas Virtuais';
    ...
    langEN.addEventListener('click', () => {
        ...
        document.getElementById('service-1').textContent = 'Landing Pages';
        document.getElementById('service-2').textContent = 'Websites';
        document.getElementById('service-3').textContent = 'E-commerce';
    ...
    langES.addEventListener('click', () => {
        ...
        document.getElementById('service-1').textContent = 'Landing Pages';
        document.getElementById('service-2').textContent = 'Sitios Web';
        document.getElementById('service-3').textContent = 'E-commerce';
