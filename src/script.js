...
document.addEventListener('DOMContentLoaded', () => {
  ...
  themeToggle.addEventListener('change', function() {
   ...
   langPT.addEventListener('click', () => {
        ...
        document.getElementById('service-7-description').textContent = 'Sua marca começa com uma identidade visual marcante. Desenvolvemos logotipos, cores e elementos visuais que representam sua empresa de forma única, atraindo atenção e criando uma conexão emocional com seus clientes.';
