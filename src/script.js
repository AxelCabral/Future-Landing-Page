...
document.addEventListener('DOMContentLoaded', () => {
  ...
  themeToggle.addEventListener('change', function() {
   ...
   langPT.addEventListener('click', () => {
        ...
        document.getElementById('service-7').textContent = 'Identidade Visual';
        document.getElementById('service-8').textContent = 'Logotipo 3D';
        ...
        document.getElementById('second-info-description').textContent = '47% dos usuários, esperam, no máximo, 2 segundos até o carregamento da página. Com um desempenho de excelência, você atrai mais visitantes e alevará o nível da sua empresa no mercado.';
    ...
    langEN.addEventListener('click', () => {
        ...
        document.getElementById('service-7').textContent = 'Visual Identity';
        document.getElementById('service-8').textContent = '3D Logo';
        ...
        document.getElementById('service-8-description').textContent = 'Stand out with an innovative and impactful 3D logo. We create three-dimensional logos that grab attention and make your brand memorable, bringing a modern and distinctive look.';
    ...
    langES.addEventListener('click', () => {
        ...
        document.getElementById('service-7').textContent = 'Identidad Visual';
        document.getElementById('service-8').textContent = 'Logotipo 3D';
        ...
        document.getElementById('service-7-description').textContent = 'Tu marca comienza con una identidad visual impactante. Desarrollamos logotipos, colores y elementos visuales que representan tu empresa de manera única, atrayendo atención y creando una conexión emocional con tus clientes.';
        document.getElementById('service-8-description').textContent = 'Destácate con un logotipo 3D innovador e impactante. Creamos logotipos tridimensionales que llaman la atención y hacen que tu marca sea memorable, brindando un aspecto moderno y diferenciado.';
